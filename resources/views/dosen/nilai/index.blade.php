            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_mk" class="form-select" data-control="select2" id="from_select_mk"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger uuid_mk_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/dosen/add-nilai', 'Tambah',
                    'Nilai',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/dosen/update-nilai/' + uuid,
                    'Update',
                    'Nilai', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            control.overlay_form('Update', 'Nilai', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/dosen/delete-nilai/' + $(this).attr('data-uuid');
            ...
            $('#kt_table_data').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <a href="javascript:;" type="button" data-uuid="${data}" data-label="Nilai" class="btn btn-danger button-delete btn-icon btn-sm">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
