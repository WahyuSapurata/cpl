...
@if (auth()->user()->role != 'kajur' && auth()->user()->role != 'operator' && auth()->user()->role != 'lpm' && auth()->user()->role != 'admin')
    @section('button')
        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        <label class="form-label">Kode IK</label>
    ...
    <script>
            ...
            try {
                ...
                if (res.success === true) {
                    ...
                    $(document).on('submit', ".form-data", function(e) {
                        ...
                        // Menambahkan nilai 'uuid_client' ke FormData
                        ...
                        if (type == 'add') {
                            control.submitForm('/dosen/add-nilai', 'Tambah',
                                'Nilai IK',
                                'POST', formData);
                        } else {
                            let uuid = $("input[name='uuid']").val();
                            control.submitForm('/dosen/update-nilai/' + uuid,
                                'Update',
                                'Nilai IK', 'POST', formData);
                        }
                    });
        ...
        const initDatatable = async (selectedUuid) => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/dosen/get-nilai/' + selectedUuid,
                columns: [{
                        data: null,
                    ...
                    columnDefs: [{
                        ...
                        render: function(data, type, full, meta) {
                            return `
                                    ...
                                    <a href="javascript:;" type="button" data-uuid="${data}" data-label="Nilai IK" class="btn btn-danger button-delete btn-icon btn-sm">
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
