            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" id="tahun_mulai" class="form-control" name="tahun_mulai">
                        <small class="text-danger tahun_mulai_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Tahun Berakhir</label>
                        <input type="number" id="tahun_berakhir" class="form-control" name="tahun_berakhir">
                        <small class="text-danger tahun_berakhir_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Kurikulum');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/operator/data-master/add-kurikulum', 'Tambah',
                    'Kurikulum',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/operator/data-master/update-kurikulum/' + uuid,
                    'Update',
                    'Kurikulum', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/operator/data-master/show-kurikulum/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Kurikulum', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/operator/data-master/delete-kurikulum/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/operator/data-master/get-kurikulum',
                columns: [{
                    data: null,
                    ...
                    className: 'text-center',
                    render: function(data, type, row, meta) {
                        return row.tahun_mulai + ' Sampai ' + row.tahun_berakhir;
                    }
                }, {
                    data: 'uuid',
                }],
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Kurikulum" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
