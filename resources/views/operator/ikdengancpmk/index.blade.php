            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_ik" class="form-select" data-control="select2" id="from_select_ik"
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_mata_kuliah" class="form-select" data-control="select2" id="from_select_mk"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger uuid_mata_kuliah_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'IK Dengan CPMK');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/operator/add-ikdengancpmk', 'Tambah',
                    'IK Dengan CPMK',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/operator/update-ikdengancpmk/' + uuid,
                    'Update',
                    'IK Dengan CPMK', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/operator/show-ikdengancpmk/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'IK Dengan CPMK', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/operator/delete-ikdengancpmk/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/operator/get-ikdengancpmk',
                columns: [{
                    data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <a href="javascript:;" type="button" data-uuid="${data}" data-label="IK Dengan CPMK" class="btn btn-danger button-delete btn-icon btn-sm">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
