            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="kode_ik" class="form-control" name="kode_ik">
                        <small class="text-danger kode_ik_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Kemampuan</label>
                        <input type="text" id="kemampuan" class="form-control" name="kemampuan">
                        <small class="text-danger kemampuan_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Indikator Kinerja');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/operator/add-indikator-kinerja', 'Tambah',
                    'Indikator Kinerja',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/operator/update-indikator-kinerja/' + uuid,
                    'Update',
                    'Indikator Kinerja', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/operator/show-indikator-kinerja/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Indikator Kinerja', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/operator/delete-indikator-kinerja/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/operator/get-indikator-kinerja',
                columns: [{
                        data: null,
                ...
                @if (auth()->user()->role != 'kajur')
                    columnDefs: [{
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Indikator Kinerja" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
