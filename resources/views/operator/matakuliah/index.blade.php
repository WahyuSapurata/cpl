            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="kode_mk" class="form-control" name="kode_mk">
                        <small class="text-danger kode_mk_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Mata Kuliah</label>
                        <input type="text" id="mata_kuliah" class="form-control" name="mata_kuliah">
                        <small class="text-danger mata_kuliah_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Nama Dosen</label>
                        <select name="uuid_dosen" class="form-select" data-control="select2" id="from_select"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger uuid_dosen_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Mata Kuliah');
        })
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Mata Kuliah" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
