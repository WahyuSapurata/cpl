...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/operator/data-master/add-mahasiswa', 'Tambah',
                    'Mahasiswa',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/operator/data-master/update-mahasiswa/' + uuid,
                    'Update',
                    'Mahasiswa', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/operator/data-master/show-mahasiswa/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Mahasiswa', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/operator/data-master/delete-mahasiswa/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/operator/data-master/get-mahasiswa',
                columns: [{
                    data: null,
